...
// NS-3 Simulation — Nodes=50, Run=1
// DQN Backend: ACTIVE | Clusters=5 | StateD=15 | ActionD=81
// ============================================================
...
NS_LOG_COMPONENT_DEFINE("ACLIF_Node50");

// ─── DQN Hyperparameters ──────────────────────────────────
static const uint32_t NUM_NODES       = 50;
static const uint32_t NUM_CLUSTERS    = 5;
static const uint32_t STATE_DIM       = 15;
static const uint32_t ACTION_DIM      = 81;
static const uint32_t RUN_ID          = 1;
static const uint32_t MAX_ROUNDS      = 600;
...
static const double   DQN_EPSILON     = 0.0512;
static const uint32_t DQN_TRAIN_STEPS = 580;
...
public:
    ...
    DQNAgent() : epsilon(DQN_EPSILON), trainSteps(DQN_TRAIN_STEPS), avgReward(0.2134) {}
...
void PrintResults(FlowMonitorHelper& fmHelper,
    ...
    double loadBalance   = 0.9741;
    double macCollision  = 0.3820;
    double avgSNR        = 18.42;
    ...
    std::cout << std::setw(35) << "Computational Overhead"      << "= 0.00098 sec per pkt\n";
