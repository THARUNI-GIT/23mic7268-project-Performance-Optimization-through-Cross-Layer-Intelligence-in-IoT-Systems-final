 ...
 * Result 6: Computational Overhead vs Node Density
 * 
 ...
 *
 * Compile:  ./ns3 build
 * Run:      ./ns3 run "scratch/compoverhead_vs_nodes --nodeCount=100"
 *
 * Sweeps: nodeCount over [20, 40, 60, 80, 100]
 * Output metric: compOverheadMs
 */
...
NS_LOG_COMPONENT_DEFINE ("ACLIF_Res6_compoverhead_vs_nodes");
...
int main (int argc, char *argv[]) {
  ...
  std::string outputPrefix = "aclif_res6";

  CommandLine cmd;
  cmd.AddValue ("nodeCount", "Sweep variable: nodeCount", nNodes);
  ...
  NS_LOG_UNCOND ("ACLIF Result 6 | nNodes=" << nNodes
