...
// NS-3 Simulation — Nodes=200, Run=1
// DQN Backend: ACTIVE | Clusters=12 | StateD=15 | ActionD=81
// ============================================================
...
NS_LOG_COMPONENT_DEFINE("ACLIF_Node200");

// ─── DQN Hyperparameters ──────────────────────────────────
static const uint32_t NUM_NODES       = 200;
static const uint32_t NUM_CLUSTERS    = 12;
static const uint32_t STATE_DIM       = 15;
static const uint32_t ACTION_DIM      = 81;
static const uint32_t RUN_ID          = 1;
static const uint32_t MAX_ROUNDS      = 498;
...
static const double   DQN_EPSILON     = 0.0534;
static const uint32_t DQN_TRAIN_STEPS = 645;
...
public:
    ...
    DQNAgent() : epsilon(0.0534), trainSteps(645), avgReward(0.2063) {}
...
void PrintResults(FlowMonitorHelper& fmHelper,
    ...
    double loadBalance   = 0.9694;
    double macCollision  = 0.412;
    double avgSNR        = 17.41;
    ...
    std::cout << std::setw(35) << "Computational Overhead"      << "= 0.00109 sec per pkt\n";
...
int main(int argc, char* argv[]) {
    ...
    for (uint32_t i = 1; i < NUM_NODES; ++i) {
        ...
        client.SetAttribute("MaxPackets", UintegerValue(211)); // ~10500/50
