 ...
 * Result 9: Comparative Radar Summary
 * 
 ...
 *
 * Compile:  ./ns3 build
 * Run:      ./ns3 run "scratch/radar_comparison --method=100"
 *
 * Sweeps: method over [all]
 * Output metric: normalisedScores
 */
...
NS_LOG_COMPONENT_DEFINE ("ACLIF_Res9_radar_comparison");
...
int main (int argc, char *argv[]) {
  ...
  std::string outputPrefix = "aclif_res9";
  ...
  NS_LOG_UNCOND ("ACLIF Result 9 | nNodes=" << nNodes
