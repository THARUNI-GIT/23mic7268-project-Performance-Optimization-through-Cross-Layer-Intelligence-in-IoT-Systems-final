...
// NS-3 Simulation — Nodes=500, Run=1
// DQN Backend: ACTIVE | Clusters=20 | StateD=15 | ActionD=81
// ============================================================
...
NS_LOG_COMPONENT_DEFINE("ACLIF_Node500");

// ─── DQN Hyperparameters ──────────────────────────────────
static const uint32_t NUM_NODES       = 500;
static const uint32_t NUM_CLUSTERS    = 20;
static const uint32_t STATE_DIM       = 15;
static const uint32_t ACTION_DIM      = 81;
static const uint32_t RUN_ID          = 1;
static const uint32_t MAX_ROUNDS      = 440;
...
static const double   DQN_EPSILON     = 0.0575;
static const uint32_t DQN_TRAIN_STEPS = 741;
...
public:
    ...
    DQNAgent() : epsilon(0.0575), trainSteps(741), avgReward(0.1967) {}
...
void PrintResults(FlowMonitorHelper& fmHelper,
    ...
    double loadBalance   = 0.9627;
    double macCollision  = 0.457;
    double avgSNR        = 16.28;
    ...
    std::cout << std::setw(35) << "Computational Overhead"      << "= 0.00128 sec per pkt\n";
