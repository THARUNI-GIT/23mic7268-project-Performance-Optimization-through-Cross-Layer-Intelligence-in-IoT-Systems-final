 ...
 * Result 12: Mobility Impact on Delay
 * 
 ...
 *
 * Compile:  ./ns3 build
 * Run:      ./ns3 run "scratch/mobility_impact --mobilityModel=100"
 *
 * Sweeps: mobilityModel over [Static,ConstVel,RWP]
...
NS_LOG_COMPONENT_DEFINE ("ACLIF_Res12_mobility_impact");
...
int main (int argc, char *argv[]) {
  ...
  std::string outputPrefix = "aclif_res12";

  CommandLine cmd;
  cmd.AddValue ("mobilityModel", "Sweep variable: mobilityModel", nNodes);
  ...
  NS_LOG_UNCOND ("ACLIF Result 12 | nNodes=" << nNodes
