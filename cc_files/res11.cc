 ...
 * Result 11: Sensitivity: Path-Loss Exponent
 * 
 ...
 *
 * Compile:  ./ns3 build
 * Run:      ./ns3 run "scratch/sensitivity_alpha --alpha=100"
 *
 * Sweeps: alpha over [2.0, 2.5, 3.0, 3.5, 4.0]
...
NS_LOG_COMPONENT_DEFINE ("ACLIF_Res11_sensitivity_alpha");
...
int main (int argc, char *argv[]) {
  ...
  std::string outputPrefix = "aclif_res11";

  CommandLine cmd;
  cmd.AddValue ("alpha", "Sweep variable: alpha", nNodes);
  ...
  NS_LOG_UNCOND ("ACLIF Result 11 | nNodes=" << nNodes
