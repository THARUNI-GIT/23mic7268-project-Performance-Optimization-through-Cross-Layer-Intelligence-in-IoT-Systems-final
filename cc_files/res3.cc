 ...
 *
 * Compile:  ./ns3 build
 * Run:      ./ns3 run "scratch/throughput_vs_rate --packetRate=100"
 *
 * Sweeps: packetRate over [1, 2, 4, 6, 8, 10]
 * Output metric: throughputKbps
 */
...
NS_LOG_COMPONENT_DEFINE ("ACLIF_Res3_throughput_vs_rate");
...
int main (int argc, char *argv[]) {
  ...
  std::string outputPrefix = "aclif_res3";
  ...
  NS_LOG_UNCOND ("ACLIF Result 3 | nNodes=" << nNodes
