 ...
 * Result 2: Energy Consumption vs Simulation Rounds
 * 
 ...
 *
 * Compile:  ./ns3 build
 * Run:      ./ns3 run "scratch/energy_vs_rounds --simRounds=100"
 *
 * Sweeps: simRounds over [50, 100, 150, 200, 250, 300]
 * Output metric: avgEnergy
 */
...
NS_LOG_COMPONENT_DEFINE ("ACLIF_Res2_energy_vs_rounds");
...
int main (int argc, char *argv[]) {
  ...
  std::string outputPrefix = "aclif_res2";

  CommandLine cmd;
  cmd.AddValue ("simRounds", "Sweep variable: simRounds", nNodes);
  ...
  NS_LOG_UNCOND ("ACLIF Result 2 | nNodes=" << nNodes
