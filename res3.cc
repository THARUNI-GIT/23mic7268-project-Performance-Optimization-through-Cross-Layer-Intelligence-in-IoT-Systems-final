 ...
 *
 * Compile:  ./ns3 build
 * Run:      ./ns3 run "scratch/commoverhead_vs_rate --packetRate=100"
 *
 * Sweeps: packetRate over [1, 2, 4, 6, 8, 10]
 * Output metric: commOverhead
 */
...
NS_LOG_COMPONENT_DEFINE ("ACLIF_Res5_commoverhead_vs_rate");
...
int main (int argc, char *argv[]) {
  ...
  std::string outputPrefix = "aclif_res5";

  CommandLine cmd;
  cmd.AddValue ("packetRate", "Sweep variable: packetRate", nNodes);
  ...
  NS_LOG_UNCOND ("ACLIF Result 5 | nNodes=" << nNodes
