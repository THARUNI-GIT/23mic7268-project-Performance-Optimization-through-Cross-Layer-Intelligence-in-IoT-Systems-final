 ...
 *
 * Compile:  ./ns3 build
 * Run:      ./ns3 run "scratch/delay_energy_tradeoff --method=100"
 *
 * Sweeps: method over [E-GLBR,FDRL,FACSO,EEHCT,IPSO,ACLIF]
 * Output metric: delay_energy
 */
...
NS_LOG_COMPONENT_DEFINE ("ACLIF_Res7_delay_energy_tradeoff");
...
int main (int argc, char *argv[]) {
  ...
  std::string outputPrefix = "aclif_res7";

  CommandLine cmd;
  cmd.AddValue ("method", "Sweep variable: method", nNodes);
  ...
  NS_LOG_UNCOND ("ACLIF Result 7 | nNodes=" << nNodes
