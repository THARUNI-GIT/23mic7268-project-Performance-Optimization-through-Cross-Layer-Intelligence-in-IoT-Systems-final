 ...
 *
 * Compile:  ./ns3 build
 * Run:      ./ns3 run "scratch/ablation --variant=100"
 *
 * Sweeps: variant over [Full,NoPwr,NoRoute,NoRate]
 * Output metric: allMetrics
 */
...
NS_LOG_COMPONENT_DEFINE ("ACLIF_Res8_ablation");
...
int main (int argc, char *argv[]) {
  ...
  std::string outputPrefix = "aclif_res8";

  CommandLine cmd;
  cmd.AddValue ("variant", "Sweep variable: variant", nNodes);
  ...
  NS_LOG_UNCOND ("ACLIF Result 8 | nNodes=" << nNodes
