 ...
 * Result 1: Average Delay vs Node Density
 * 
...
NS_LOG_COMPONENT_DEFINE ("ACLIF_Res1_delay_vs_nodes");
...
int main (int argc, char *argv[]) {
  ...
  std::string outputPrefix = "aclif_res1";
  ...
  NS_LOG_UNCOND ("ACLIF Result 1 | nNodes=" << nNodes
