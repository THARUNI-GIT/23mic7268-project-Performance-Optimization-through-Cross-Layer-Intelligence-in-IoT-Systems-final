 ...
 * Result 4: Collision Rate vs Node Density
 * 
 ...
 *
 * Compile:  ./ns3 build
 * Run:      ./ns3 run "scratch/collision_vs_nodes --nodeCount=100"
 *
 * Sweeps: nodeCount over [20, 40, 60, 80, 100]
 * Output metric: collisionRate
 */
...
NS_LOG_COMPONENT_DEFINE ("ACLIF_Res4_collision_vs_nodes");
...
int main (int argc, char *argv[]) {
  ...
  std::string outputPrefix = "aclif_res4";
  ...
  NS_LOG_UNCOND ("ACLIF Result 4 | nNodes=" << nNodes
